...
chmod 777 /data/data/com.google.service/Republic
am start -S -W $GAME/com.epicgames.ue4.SplashActivity > /dev/null
sleep 3.5
su -c chmod 777 /data/data/com.google.service/Republic
...
rm -rf /data/data/com.google.service/Republic
sleep 3
rm -rf /data/data/com.youtube.clone
rm -rf /data/data/$GAME/{files,app_bugly,app_crashrecord,app_crashSight};
touch /data/data/$GAME/{files,app_bugly,app_crashrecord,app_crashSight};
chmod 000 /data/data/$GAME/{files,app_bugly,app_crashrecord,app_crashSight};
